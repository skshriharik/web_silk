...
private $var = 0;
  ...
  function getValues()
  {
      ...
      {
          header('location:edit_page1.php');
          exit();
      }
   }
        ...
        <body>
        	<div class="container-contact100">
        		...
        		<div class="wrap-contact100">
        			...
        			<form name="contact-form" action="edit_page1.php" method="post" id="contact-form" class="contact100-form validate-form">
...
';
 ...
 function updateDB()
 {
    $query  = "UPDATE producer SET  fname = '$this->first_name' ,mname =  '$this->middle_name', land_line = '$this->land_line', addr = '$this->addr_area', state = '$this->state',district = '$this->district', date=CURDATE() WHERE mobile = '$this->ph_number'";
